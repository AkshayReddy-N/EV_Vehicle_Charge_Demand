...
st.markdown("""
    <style>
        ...
        .stApp {
            background: linear-gradient(to right, #3a4a5b, #5e7385);
        }
    </style>
...
st.markdown("""
    <div style='text-align: center; font-size: 36px; font-weight: bold; color: #FFFFFF; margin-top: 20px;'>
        ⚡ Predictive Dashboard for EV Charging and Vehicle Growth for a County in Washington State
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: center; font-size: 22px; font-weight: bold; padding-top: 10px; margin-bottom: 25px; color: #FFFFFF;'>
        Welcome to the Electric Vehicle Demand and Charging Forecasting tool.
    </div>
""", unsafe_allow_html=True)
...
st.markdown("""
    <div style='text-align: left; font-size: 22px; padding-top: 10px; color: #FFFFFF;'>
        Choose a county to explore projected EV growth and charging demand over the next 3 years.
    </div>
""", unsafe_allow_html=True)
